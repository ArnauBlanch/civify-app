...
public class RegistrationPageTransformer implements ViewPager.PageTransformer {
  ...
  public void transformPage(View page, float position) {
    ...
    if (position <= -1.0f || position >= 1.0f) {
      ...
      //View editTextLayout = page.findViewById(R.id.edit_text_layout);
      //editTextLayout.setTranslationY(-pageWidthTimesPosition / 2f);
      //editTextLayout.setAlpha(1.0f - absPosition);//
