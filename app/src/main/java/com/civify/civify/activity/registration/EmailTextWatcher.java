...
class EmailTextWatcher implements TextWatcher {
    ...
    public EmailTextWatcher(Context context, View view, int iconResource, int messageResource) {
        super();
    ...
    public void afterTextChanged(Editable s) {
        switch (mUserAdapter.checkValidUnusedEmail(s.toString())) {
            case UserAdapter.VALID_UNUSED:
                setIconAndMessage(R.drawable.ic_checked, R.string.valid_unused_email, R.color.green);
                break;
            case UserAdapter.INVALID:
                setIconAndMessage(R.drawable.ic_cancel, R.string.invalid_email, R.color.red);
                break;
            case UserAdapter.USED:
                setIconAndMessage(R.drawable.ic_cancel, R.string.used_email, R.color.red);
                break;
        }
    }
